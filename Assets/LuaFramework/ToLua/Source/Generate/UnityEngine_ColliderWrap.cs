...
public class UnityEngine_ColliderWrap
{
	...
	static int get_attachedArticulationBody(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index attachedArticulationBody on a nil value" : e.Message);
		}
	}
	...
	static int get_hasModifiableContacts(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index hasModifiableContacts on a nil value" : e.Message);
		}
	}
