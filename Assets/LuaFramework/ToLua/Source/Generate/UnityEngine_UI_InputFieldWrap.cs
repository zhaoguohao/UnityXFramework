...
public class UnityEngine_UI_InputFieldWrap
{
	...
	static int get_shouldActivateOnSelect(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index shouldActivateOnSelect on a nil value" : e.Message);
		}
	}
	...
	static int get_touchScreenKeyboard(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index touchScreenKeyboard on a nil value" : e.Message);
		}
	}
	...
	static int set_onEndEdit(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.UI.InputField obj = (UnityEngine.UI.InputField)o;
			UnityEngine.UI.InputField.EndEditEvent arg0 = (UnityEngine.UI.InputField.EndEditEvent)ToLua.CheckObject(L, 2, typeof(UnityEngine.UI.InputField.EndEditEvent));
			obj.onEndEdit = arg0;
			return 0;
		}
		catch(Exception e)
