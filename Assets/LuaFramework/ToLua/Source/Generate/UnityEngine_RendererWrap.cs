...
public class UnityEngine_RendererWrap
{
	...
	static int SetPropertyBlock(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Renderer), typeof(UnityEngine.MaterialPropertyBlock)))
			{
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Renderer), typeof(UnityEngine.MaterialPropertyBlock), typeof(int)))
			{
				UnityEngine.Renderer obj = (UnityEngine.Renderer)ToLua.ToObject(L, 1);
				UnityEngine.MaterialPropertyBlock arg0 = (UnityEngine.MaterialPropertyBlock)ToLua.ToObject(L, 2);
	...
	static int get_forceRenderingOff(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index forceRenderingOff on a nil value" : e.Message);
		}
	}
	...
	static int get_staticShadowCaster(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index staticShadowCaster on a nil value" : e.Message);
		}
	}
	...
	static int get_rendererPriority(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index rendererPriority on a nil value" : e.Message);
		}
	}
	...
	static int get_rayTracingMode(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index rayTracingMode on a nil value" : e.Message);
		}
	}
	...
	static int get_allowOcclusionWhenDynamic(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index allowOcclusionWhenDynamic on a nil value" : e.Message);
		}
	}
