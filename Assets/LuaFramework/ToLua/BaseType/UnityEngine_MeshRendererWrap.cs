...
public class UnityEngine_MeshRendererWrap
{
	...
	static int get_enlightenVertexStream(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index enlightenVertexStream on a nil value" : e.Message);
		}
	}
	...
	static int get_subMeshStartIndex(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index subMeshStartIndex on a nil value" : e.Message);
		}
	}
	...
	static int get_scaleInLightmap(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index scaleInLightmap on a nil value" : e.Message);
		}
	}
	...
	static int get_receiveGI(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index receiveGI on a nil value" : e.Message);
		}
	}
	...
	static int get_stitchLightmapSeams(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index stitchLightmapSeams on a nil value" : e.Message);
		}
	}
